                            ...
                            >
                                <div class="list-wrap">
                                    <div class="p-img">
                                        <!-- 在路由跳转的时候携带商品id -->
                                        <router-link
                                            :to="`/detail/${goodsList.id}`"
                                        >
                                            <img
                                                v-lazy="goodsList.defaultImg"
                                            />
                                        </router-link>
                                    </div>
                                    <div class="price">
...
export default {
    ...
    mounted() {
        ...
        this.$bus.$on("addTmName", (tmStr) => {
            this.searchParams.trademark = tmStr;
            this.$route.query.trademark = tmStr;
            this.getData();
        });
        this.$bus.$on("addProps", (propsStr) => {
            this.searchParams.props.push(propsStr);
            this.searchParams.props = [...new Set(this.searchParams.props)];
            this.$route.query.props = this.searchParams.props;
            this.getData();
        });
    },
    computed: {
